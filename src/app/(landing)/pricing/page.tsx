  ...
  return (
    <section className="container flex flex-col  gap-6 py-8 md:max-w-[64rem]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        <div className="grid w-full items-start gap-10 rounded-lg border p-10 md:grid-cols-[1fr_200px] col-span-4">
        ...
        <div className="grid w-full items-start gap-10 rounded-lg border p-10 md:grid-cols-[1fr_200px]  col-span-8">
