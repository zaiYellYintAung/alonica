...
const LandingFooter = () => {
  ...
  return (
    <div className=" mt-6 md:mt-24 bg-background  border-t">
      <section className="h-36 md:h-60 container mx-auto">
        <main className="md:flex justify-between container mx-auto py-6 hidden">
          <div className="w-2/5 text-gray-700 dark:text-gray-300">Nothing</div>
